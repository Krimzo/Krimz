...
public class Ray {
    ...
    boolean intersect(Triangle triangle, Float3 outInter) {
        ...
        final Float3 edge1 = triangle.b.world.sub(triangle.a.world).xyz();
        final Float3 edge2 = triangle.c.world.sub(triangle.a.world).xyz();
        ...
        // More calculations
        final Float3 s = origin.sub(triangle.a.world.xyz());
